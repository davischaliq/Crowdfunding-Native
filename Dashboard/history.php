  ...
  <div class="container">
    <div class="row ipad-width">
      <div class="tab-content">
        ...
        <?php endif; ?>
            <form action="<?= BASEURL; ?>app/function/SendReport.php?list=<?= $id ?>" method="POST" enctype="multipart/form-data">
              <div class="mb-3">
                <label for="formFile" class="form-label">photo kegiatan 1</label>
                    <input class="form-control" name="kegiatan_satu" type="file" id="formFile" required>
                    <div id="emailHelp" class="form-text">please upload photo with resolution 1504x1000px.</div>
                      </div>
                        <div class="mb-3">
                          <label for="formFile" class="form-label">photo kegiatan 2</label>
                            <input class="form-control" name="kegiatan_dua" type="file" id="formFile" required>
                            <div id="emailHelp" class="form-text">please upload photo with resolution 1504x1000px.</div>
                              </div>
                                <div class="mb-3">
                                  <label for="formFile" class="form-label">photo kegiatan 3</label>
                                    <input class="form-control" name="kegiatan_tiga" type="file" id="formFile" required>
                                    <div id="emailHelp" class="form-text">please upload photo with resolution 1504x1000px.</div>
                                      </div>
                                        <div class="mb-3">
                                          <label for="formFile" class="form-label">photo kegiatan 4</label>
                                            <input class="form-control" name="kegiatan_empat" type="file" id="formFile" required>
                                            <div id="emailHelp" class="form-text">please upload photo with resolution 1504x1000px.</div>
                                              </div>
                                                <div class="mb-3">
                                            ...
                                            <?php if ($status[0]['decision'] == 'onproduction' OR $status[0]['decision'] == 'release'): ?>
                                          <div class="mb-3">
                                        <label for="formFile" class="form-label">link Triler Youtube</label>
                            ...
                            <option selected>Pilih Status...</option>
                                <option value="release">release</option>
                                  <option value="onproduction">onproduction</option>
                                    </select>
                                      </div>
