  ...
  <div class="container">
    <div class="row ipad-width">
      <div class="tab-content">
        ...
        <?php endif; ?>
            <form action="<?= BASEURL; ?>app/function/edit.php?agrement=<?= $id; ?>" method="POST" enctype="multipart/form-data">
              <div class="mb-3">
                <label for="formFile" class="form-label">Movie Id</label>
                  <input class="form-control" value="<?= $movie_id; ?>" type="text" id="formFile" readonly>
                </div>
              <div class="mb-3">
                <label for="formFile" class="form-label">Agrement File</label>
                    <input class="form-control" name="agrement" type="file" id="formFile" required>
                      <div id="emailHelp" class="form-text">please upload the signed agreement file here</div>
                        </div>
